    ...
    public class InMemoryProductDal : IProductDal
    {
        ...
        public InMemoryProductDal()
        {
            ...
            { 
                ...
                new Product{ProductId= 4, CategoryId=2, ProductName="Klavye", UnitPrice=150, UnitInStock=15},
                new Product{ProductId= 5, CategoryId=2, ProductName="Fare", UnitPrice=85, UnitInStock=15},
            };
        }
